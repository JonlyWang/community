...
class Graph {
  ...
  getTopSortedWithSccSubgraphFrom(modifiedNodes, operatingFunction, onCycle) {
    ...
    const inSCC = new Set(); // node status life cycle:
    ...
    modifiedNodes.forEach(v => {
      ...
      while (DFSstack.length > 0) {
        const u = DFSstack[DFSstack.length - 1]; // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
          ...
          case NodeVisitStatus.PROCESSED:
            {
              ...
              let uLow; // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
