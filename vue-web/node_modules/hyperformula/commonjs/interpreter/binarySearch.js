...
function rangeLowerBound(range, key, dependencyGraph, coordinate) {
  ...
  if (coordinate === 'row') {
    centerValueFn = center => (0, _InterpreterValue.getRawValue)(dependencyGraph.getCellValue((0, _Cell.simpleCellAddress)(range.sheet, range.start.col, center)));
  } else {
    centerValueFn = center => (0, _InterpreterValue.getRawValue)(dependencyGraph.getCellValue((0, _Cell.simpleCellAddress)(range.sheet, center, range.start.row)));
  }
