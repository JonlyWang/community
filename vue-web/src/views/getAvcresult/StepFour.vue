  ...
  <a-card :bordered="false">
    <div style="margin: 3px auto 0;">
      <a-form :model="formState" name="custom-validation" :rules="rules"
        ...
        <h5 style="text-align: center;margin: 20px;">匿名灵活投票链上选票信息汇总</h5>
        ...
        <div class="step-form-style-desc">
          <h3>说明</h3>
          <h4>获取匿名灵活信息意见表决办法注意事项：请根据以上项目ID返回信息获取投票结果。</h4>
        </div>
      </a-form>
    </div>
  </a-card>
...
export default defineComponent({
  ...
  methods: {
    ...
    getres() {
      ...
      this.$http.post('http://192.168.5.42:9999/voteravc/get_avc_result', {
